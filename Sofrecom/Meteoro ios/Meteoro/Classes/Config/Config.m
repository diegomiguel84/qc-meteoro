...
-(id) init
{
    ...
    if (self) {
        ...
        dateWeekFormatter = [[NSDateFormatter alloc] init];
        [dateWeekFormatter setDateFormat:@"EEEE"];
        [dateWeekFormatter setLocale:[NSLocale currentLocale]];
        
        dateFormatterAR = [[NSDateFormatter alloc] init];
        [dateFormatterAR setDateFormat:@"dd/MM/yyyy HH:mm:ss"];
        [dateFormatterAR setLocale:[NSLocale currentLocale]];
...
-(BOOL)ContainsCity:(City*)city
{
    ...
    {
        City * aCity = [cities objectAtIndex:i];
        if([aCity.code isEqualToString:city.code])
        {
            return YES;
        }
    }
...
-(NSString*) ImageName:(NSString *)status
{
    NSDictionary *dict;
    
    dict =  [NSDictionary dictionaryWithObjectsAndKeys:
            @"status_cloudy.png",@"cloudy",
            @"status_partly_cloudy.png",@"partly cloudy",
            @"status_clear.png",@"clear",
            @"status_showers.png",@"showers",
            @"status_fog.png",@"fog",
            @"status_scattered_showers.png",@"scattered showers",
            @"status_windy.png",@"windy",
            @"status_snow.png",@"snow",
            @"status_storm.png",@"storm",
            @"status_snow_rain.png",@"snow rain", nil];
    
    NSString * result = (NSString *)[dict objectForKey:status];
    return result;
...
- (NSString*) dateToStringAR:(NSDate*) date
{
	return [dateFormatterAR stringFromDate:date];
}
...
{
    return [dateWeekFormatter stringFromDate:date];
}
